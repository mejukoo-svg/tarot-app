        ...
        {supabaseStatus === 'connected' ? (
          ...
          <div className="bg-red-900/30 rounded-lg p-4 border border-red-300/10 text-left">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="font-semibold text-red-200 mb-2">Vercel 환경 변수 설정:</h4>
                <ol className="text-red-200/80 space-y-1 text-sm ml-4">
                  <li>1. <a href="https://vercel.com/dashboard" target="_blank" rel="noopener noreferrer" className="text-red-300 underline">Vercel 대시보드</a> 접속</li>
                  <li>2. 프로젝트 선택 → Settings → Environment Variables</li>
                  <li>3. 다음 변수 추가:</li>
                </ol>
    ...
    const testSupabaseConnection = async () => {
      try {
        ...
        if (!supabase) {
          ...
          setConnectionMessage('⚠️ Supabase 환경 변수가 설정되지 않았습니다.');
          
          // 콘솔에 자세한 설정 가이드 출력
          console.error('📋 Vercel 환경 변수 설정 가이드:');
          console.error('1. Vercel 대시보드 → Project Settings → Environment Variables');
          console.error('2. 다음 변수들을 추가:');
        ...
        const dbInfo = getDatabaseInfo();
        setSupabaseStatus('error');
        setConnectionMessage(`❌ ${dbInfo.type || 'Supabase'} 연결 실패: ${error.message}`);
          ...
          <div className="max-w-4xl mx-auto px-4 py-8">
            <div className="bg-black/20 backdrop-blur-sm rounded-xl p-8 border border-purple-300/20">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-purple-900/30 rounded-lg p-6 border border-purple-300/10">
                  <h3 className="text-xl font-semibold text-gold-300 mb-4">2. Vercel 환경변수 설정</h3>
                  <div className="space-y-4">
                    <div>
                      <p className="text-purple-200/80 mb-3">Vercel 대시보드에서 환경 변수를 설정하세요:</p>
                      <ol className="text-purple-200/70 space-y-2 text-sm mb-4">
                        <li>1. <a href="https://vercel.com/dashboard" target="_blank" rel="noopener noreferrer" className="text-purple-300 underline">Vercel 대시보드</a> 접속</li>
                        <li>2. 프로젝트 선택 → Settings → Environment Variables</li>
                        <li>3. 다음 변수들을 추가:</li>
                      </ol>
                    </div>
                    ...
                    <div>
                      <h4 className="text-purple-300 font-semibold mb-2">Supabase 환경 변수:</h4>
...
REACT_APP_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIs...
                    ...
                    <div className="text-purple-200/60 text-sm">
                      💡 Supabase 프로젝트의 Settings → API에서 URL과 anon key를 찾을 수 있습니다.
                    </div>
                  </div>
                </div>
